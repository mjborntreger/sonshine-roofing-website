...
const h3Styles = "text-xs md:text-sm font-bold uppercase tracking-wider text-[--brand-blue]";
          ...
          >
            ...
            <div>
              ...
              <ul className="mt-3 space-y-3 text-sm">
                ...
                <li>
                  <SmartLink
                    className="text-xs md:text-sm uppercase font-semibold text-[--brand-blue] hover:text-slate-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#00e3fe]"
