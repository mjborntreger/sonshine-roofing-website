...
import { MessageCircleQuestion, PencilLineIcon } from "lucide-react"
            ...
            <div className="grid">
                ...
                >
                    <div className="flex w-full flex-col items-start gap-2">
                        <div className="text-sm font-semibold text-slate-900"><MessageCircleQuestion className="h-4 w-4 mr-1 inline" />Need help?</div>
                ...
                >
                    <div className="flex w-full flex-col items-start gap-2">
                        <div className="text-sm text-center font-semibold text-slate-900"><PencilLineIcon className="h-4 w-4 mr-1 inline" />Prefer to write?</div>
