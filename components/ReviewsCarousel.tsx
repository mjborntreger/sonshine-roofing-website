...
export default async function ReviewsCarousel() {
  ...
  return (
    <>
      <div className="mt-16 h-1 w-full bg-gradient-to-r from-[#fb9216] via-[#fb9216]/20 to-[#fb9216]" />
      ...
      <div className="h-1 w-full bg-gradient-to-r from-[#fb9216] via-[#fb9216]/20 to-[#fb9216]" />
    </>
  );
}
