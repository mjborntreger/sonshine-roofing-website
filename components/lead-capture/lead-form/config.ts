...
export const PROJECT_OPTIONS: ProjectOption[] = [
  {
    ...
    action: 'advance',
    imageSrc: 'static:stained-roof-decking-and-framing',
  ...
  },
  {
    ...
    action: 'link',
    href: '/project',
    imageSrc: 'static:shingle-tile-metal-roof-collage',
  ...
  },
  {
    ...
    action: 'advance',
    imageSrc: 'static:colorful-question-mark-pattern',
...
export const LEAD_NAVIGATION_CARDS: LeadNavigationCard[] = [
  ...
  },
  {
    ...
    imageSrc: 'static:two-workers-on-tile-roof',
  ...
  },
  {
    ...
    imageSrc: 'static:smiling-man-holding-cash-banner',
...
const EMERGENCY_REPLACEMENT_HELP: HelpOption[] = [
  {
    ...
    icon: Droplets,
    imageSrc: 'static:peeling-ceiling-finish',
  ...
  },
  {
    ...
    icon: SunDim,
    imageSrc: 'static:shingle-and-flat-roof-junction',
  ...
  },
  {
    ...
    icon: TrendingUp,
    imageSrc: 'static:calculator-pen-printed-figures',
  ...
  },
  {
    ...
    icon: AlertTriangle,
    imageSrc: 'static:broken-red-roof-tiles',
  ...
  },
  {
    ...
    icon: ShieldCheck,
    imageSrc: 'static:roofing-worker-safety-harness',
  ...
  },
  {
    ...
    icon: HandCoins,
    imageSrc: 'static:financing-options-couple-banner',
