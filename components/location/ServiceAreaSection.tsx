  ...
  return (
    <section aria-labelledby="location-coverage" className="space-y-8">
      <div className="max-w-3xl">
        <h2 id="location-coverage" className={SECTION_HEADING}>Roofing coverage in {locationName}</h2>
        <p className="mt-3 text-lg text-slate-600">
          Explore the neighborhoods we serve. Project links are included where a published project is available.
        </p>
      </div>
