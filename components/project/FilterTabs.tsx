        ...
        {orderedTabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative rounded-full px-2 py-1.5 text-sm font-semibold transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[--brand-orange] ${
                selected
