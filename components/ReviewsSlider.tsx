          ...
          {reviews.map((r, i) => {
            ...
            return (
              <button
                ...
                className="embla__slide block relative pl-4 shrink-0 min-w-0 flex-[0_0_50%] md:flex-[0_0_33%] lg:flex-[0_0_25%] appearance-none bg-transparent p-0 m-0 text-left cursor-pointer"
              >
